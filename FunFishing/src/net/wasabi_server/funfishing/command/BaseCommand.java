...
public abstract class BaseCommand {
    // Logger
    protected static final Logger log = FunFishing.log;
    protected static final String logPrefix = FunFishing.logPrefix;
    protected static final String msgPrefix = FunFishing.msgPrefix;
    /* コマンド関係 */
    ...
    protected FunFishing plugin;

    public boolean run(final FunFishing plugin, final CommandSender sender, final String[] preArgs, final String cmd) {
        this.plugin = plugin;
